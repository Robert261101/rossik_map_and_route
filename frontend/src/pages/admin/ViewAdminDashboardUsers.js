    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center">
      <div className="relative w-full max-w-3xl bg-white dark:bg-gray-800 rounded-lg p-6 shadow-lg">
        ...
        <div className="max-h-[70vh] overflow-y-auto">
            ...
            <tbody>
                {users.map(user => (
                <tr key={user.id} className="odd:bg-gray-100 even:bg-white border-b dark:odd:bg-gray-700 dark:even:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-600 transition">
