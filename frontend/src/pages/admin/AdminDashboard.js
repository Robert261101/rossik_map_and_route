...
console.log('lucide:  ',LucideIcons);
  ...
  const Box = ({ label, type, Icon }) => (
    <div
      className="relative border border-white/30 bg-white/80 dark:bg-gray-800/30 backdrop-blur-md rounded-lg p-6 min-w-[280px] text-center shadow-xl hover:shadow-2xl transition-transform duration-300 transform hover:scale-[1.02] group"
    >
